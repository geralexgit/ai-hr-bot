...
const resources = {
  ru: {
    translation: {
      ...
      active_interviews_today: 'Активные интервью сегодня',
      ...
      view_interview_results: 'Просмотр результатов интервью',
      no_interview_results: 'Результатов интервью пока нет',
      interview_results_description: 'Кандидат еще не проходил интервью или результаты еще не обработаны.',
      loading_interview_results: 'Загрузка результатов...',
      interview_technical_skills: 'Технические навыки',
      interview_soft_skills: 'Мягкие навыки',
      overall_assessment: 'Общая оценка',
      candidate_satisfaction: 'Удовлетворенность кандидата',
      follow_up_required: 'Требуется дополнительное собеседование',
      final_feedback: 'Финальный отзыв',
      overall_impression: 'Общее впечатление',
      next_steps: 'Следующие шаги',
      interviewer_notes: 'Заметки интервьюера',
      interview_duration: 'Длительность',
      completion_percentage: 'Процент завершения',
      questions_asked: 'Вопросов задано',
      answers_received: 'Ответов получено',
      assessment_scores: 'Оценки',
  ...
  en: {
    translation: {
      ...
      active_interviews_today: 'Active Interviews Today',
      ...
      view_interview_results: 'View Interview Results',
      no_interview_results: 'No interview results yet',
      interview_results_description: 'The candidate has not yet been interviewed or the results have not been processed.',
      loading_interview_results: 'Loading results...',
      interview_technical_skills: 'Technical Skills',
      interview_soft_skills: 'Soft Skills',
